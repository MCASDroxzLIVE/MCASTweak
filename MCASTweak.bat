:: Made by MCASDroxz
:: TikTok: MCASDroxzLIVE

 
@echo off
title MCASTweak V1.0
color 8

:: (MCASTweak) Check for Admin Privileges.
fltmc >nul 2>&1
if not %errorlevel% == 0 (
    powershell -Command "Write-Host 'MCASTweak is required to be run as *Administrator.*' -ForegroundColor White -BackgroundColor Red" 
...
:: (MCASTweak) Check for Windows Defender.
...
:: (MCASTweak) Check if TrustedInstaller is disabled, for Nsudo.
...
:: (MCASTweak) Downloading MCASTweak Tools at Start, Includes NSudo, Orca and Amd.
set "fileURL=https://github.com/QuakedK/Downloads/raw/main/OneclickTools.zip"
set "fileName=MCASTweak Tools.zip"
set "extractFolder=C:\MCASTweak Tools"
...
if not exist "%downloadsFolder%\%fileName%" (
    ...
    popd
    del /q "C:\MCASTweak Tools.zip" >nul 2>&1
) else (
    echo "%fileName%" already exists in "%downloadsFolder%". >nul 2>&1
)

:: (MCASTweak) MCASTweak Start Screen.
chcp 65001 >nul 2>&1
echo.
echo.
echo.
...
if /i "%choice%"=="Y" (
    ...
    powershell -Command "Checkpoint-Computer -Description 'MCASTweak V1.0 Restore Point'"
...
cls
color D
echo (MCASTweak) Show Hidden Files and Folders...
...
cls
color D
echo (MCASTweak) Disabling Gamemode...
...
cls
color 9
echo (MCASTweak) Enabling Hardware Accelerated GPU Scheduling...
...
cls
color D
echo (MCASTweak) Disabling Transparency Effects...
...
cls
color 9
echo (MCASTweak) Running OOshutup10 with imported optimized settings...
...
set "cfgFileName=MCASTweak OOshutup10.cfg"
mkdir "C:\MCASTweak Tools\OOShutup10" >nul 2>&1
set "downloadsFolder=C:\MCASTweak Tools\OOShutup10"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
if exist "%downloadsFolder%\%exeFileName%" (
    if exist "%downloadsFolder%\%cfgFileName%" (
        ...
        echo Importing MCASTweak Config file quietly...
        "%downloadsFolder%\%exeFileName%" "%downloadsFolder%\%cfgFileName%" /quiet
        timeout 1 > nul
    ) else (
        echo Download of MCASTweak Config file failed.
...
echo. 
echo.                                  ╔═══════════════════════════════════════════════════════╗
echo.                                  ║        Running MCASTweak's Windows Cleanup...         ║       
echo.                                  ╚═══════════════════════════════════════════════════════╝
echo.
echo. 
echo.
...
color D
chcp 437 >nul
echo (MCASTweak) Disabling Regular Services...
timeout 1 > nul
...
cls
color 9
echo (MCASTweak) Disabling Hyper-V Services...
...
cls
color D
echo (MCASTweak) Disabling Browsers Services...
...
cls
color 9
echo (MCASTweak) Disabling Cpu Services...
...
"C:\MCASTweak Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\MCASTweak Tools\Amd\AMD Bloat.bat"
echo [SC] ChangeServiceConfig SUCCESS
echo [SC] ChangeServiceConfig SUCCESS
echo [SC] ChangeServiceConfig SUCCESS
echo [SC] ChangeServiceConfig SUCCESS
...
cls
color D
echo (MCASTweak) Disabling and Deleting Unnecessary Tasks...
"C:\MCASTweak Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\MCASTweak Tools\Orca\Orca.bat"
...
cls
color 9
echo (MCASTweak) Removing Xbox Gaming Service...
...
cls
color D
echo (MCASTweak) Removing GameBarPresenceWriter...
...
cls
color 9
echo (MCASTweak) Removing Microsoft Edge...
...
cls
color D
echo (MCASTweak) Removing OneDrive...
...
cls
color 9
echo (MCASTweak) Removing UsoCoreWorker and UsoClient...
...
cls
color D
echo (MCASTweak) Removing Widget and WidgetService...
...
cls
color 9
echo (MCASTweak) Removing Smartscreen...
...
cls
color D
echo (MCASTweak) Removing LockApp...
...
cls
color 9
echo (MCASTweak) Removing Windows Search and Installing alternative called "Open Shell Menu"...
echo.
chcp 437 >nul
powershell -Command "Write-Host '(Recommended)' -ForegroundColor White -BackgroundColor Red" 
echo.
...
cls
color D
echo (MCASTweak) Removing Search...
...
cls
color 9
echo (MCASTweak) Installing Alternative Search/Open Shell Menu...
chcp 437 >nul
echo.
...
mkdir "C:\MCASTweak Tools\Open Shell" >nul 2>&1
set "downloadsFolder=C:\MCASTweak Tools\Open Shell"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
if exist "%downloadsFolder%\%fileName%" (
    ...
    echo Now Navigate to your "C drive or C:\MCASTweak Tools\Open Shell" and Select "Menu_Settings_1.xml" the click "OK"
    pause
) else (
...
cls
color D
echo (MCASTweak) Disabling all startup apps...
echo --------------------------------------
...
:: (MCASTweak) Mircosoft Apps Remover.
cls
color 9
...
echo.
echo.                                  ╔═══════════════════════════════════════════════════════╗
echo.                                  ║      (MCASTweak) Automatically Detecting Gpu...       ║       
echo.                                  ╚═══════════════════════════════════════════════════════╝
echo.
echo.
echo.
...
if "%GPU_TYPE%"=="Nvidia" ((
        ...
        set "fileName2=MCASTweak Optimized NV Proflie.nip"
        mkdir "C:\MCASTweak Tools\Nvidia" >nul 2>&1
        set "downloadsFolder=C:\MCASTweak Tools\Nvidia"
        chcp 65001 >nul 2>&1
        echo.
        echo ╔═════════════════════════════╗
        echo ║                             ║
...
color D
chcp 437 >nul
echo (MCASTweak) Applying System Clock Settings...
...
cls
color 9
echo (MCASTweak) Setting Priority Separation... 
...
cls
color D
echo (MCASTweak) Installing Visual C++ 2015-2022 Redistributable...
echo.
...
mkdir "C:\MCASTweak Tools\VC Redist" >nul 2>&1
set "downloadsFolder=C:\MCASTweak Tools\VC Redist"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
cls
color 9
echo (MCASTweak) Installing and Setting up Timer Res...
set "fileURL=https://github.com/QuakedK/Downloads/raw/main/SetTimerResolution.exe"
set "fileName=SetTimerResolution.exe"
mkdir "C:\MCASTweak Tools\Timer Resolution" >nul 2>&1
set "downloadsFolder=C:\MCASTweak Tools\Timer Resolution"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
:WifiDevice
echo (MCASTweak) Disabling Wifi Devices!
echo.
...
:: (MCASTweak) Power Plan Selection.
:SkipDeviceManager
cls
chcp 65001 >nul 2>&1
color 9
...
echo. 
echo.                        ╔════════════════════════════════════════════════════════════════════════╗
echo.                        ║                   1. MCASTweak Ultimate Performance                    ║
...
echo.
echo.                        ╔════════════════════════════════════════════════════════════════════════╗
echo.                        ║          2. (Advanced) MCASTweak Ultimate Performance Idle Off:        ║
...
chcp 437 >nul
powershell -Command "Write-Host '1. (Recommended) MCASTweak Ultimate Performance' -ForegroundColor White -BackgroundColor Red"
echo 2. (Advanced) MCASTweak Ultimate Performance Idle Off
echo 3. Skip!
...
if "%option%"=="1" (
    ...
    set "fileName=MCASTweak Ultimate Performance.pow"
) else if "%option%"=="2" (
    set "fileID=1_KxNB1UDRnvXLKBS84sZX3k03ixxjogY"
    set "fileName=MCASTweak Ultimate Performance Idle Off.pow"
) else if "%option%"=="3" ( 
...
mkdir "C:\MCASTweak Tools\Power Plan" >nul 2>&1
set "downloadsFolder=C:\MCASTweak Tools\Power Plan"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
REM Check if MCASTweak Ultimate Performance power plan exists
for /f "tokens=2 delims=:(" %%i in ('powercfg /list ^| findstr /C:"MCASTweak Ultimate Performance"') do (
    set plan_guid=%%i
)

REM Check if MCASTweak Ultimate Performance Idle Off power plan exists
for /f "tokens=2 delims=:(" %%i in ('powercfg /list ^| findstr /C:"MCASTweak Ultimate Performance Idle Off"') do (
    set idle_off_guid=%%i
)
...
if defined plan_guid (
    ...
    echo Activated MCASTweak Power Plan.
    timeout 2 > nul
    goto:CheckPower    
)
...
chcp 437 >nul
color 9
echo (MCASTweak) Running File Cleanup...
...
cls
color D
echo (MCASTweak) Running Network Cleanup...
ipconfig /release
ipconfig /renew
arp -d *
nbtstat -R
...
if /i "%choice%"=="Y" (
    set "fileURL=https://github.com/QuakedK/Process-Destroyer/releases/download/tweak/MCASTweak-Process-Destroyer-2.1.bat"
    set "fileName=Process Destroyer 2.1.bat"
    mkdir "C:\MCASTweak Tools\Process Destroyer" >nul 2>&1
) else if /i "%choice%"=="N" (
    cls
...
set "downloadsFolder=C:\MCASTweak Tools\Process Destroyer"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
if exist "%downloadsFolder%\%fileName%" (
    ...
    "C:\MCASTweak Tools\NSudo\NSudoLG.exe" -ShowWindowMode:Show -U:T -P:E "C:\MCASTweak Tools\Process Destroyer\Process Destroyer 2.1.bat"
...
color D
chcp 65001 >nul 2>&1
mkdir "C:\MCASTweak Tools\App Installer" >nul 2>&1
echo.
echo.
echo.
echo.
...
if "%option%"=="1" (
    ...
    echo Your Download can be found in C:\MCASTweak Tools\App Installer
) else if "%option%"=="3" (
...
set "downloadsFolder=C:\MCASTweak Tools\App Installer"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
set /p choice=Enter (Y/N): 
if /i "%choice%"=="Y" (
    echo Running MCASTweak Networks Tweaks 
    timeout 2 > nul
    cls
    goto :NetworkTweaks
) else if /i "%choice%"=="N" ( 
    echo Skipping MCASTweak Networks Tweaks...
    timeout 2 > nul
    cls
    goto :Extra 
) else (
...
if defined adapter_name (
    echo Your current network adapter is: %adapter_name%
    echo.
    echo MCASTweak Tweaking Network Settings...
...
if "%option%"=="1" (
    ...
    mkdir "C:\MCASTweak Tools\DnsJumper" >nul 2>&1
) else if "%option%"=="2" (
...
set "downloadsFolder=C:\MCASTweak Tools\DnsJumper"
chcp 65001 >nul 2>&1
echo.
echo ╔═══════════════════════════════════════╗
echo ║                                       ║
echo ║    Downloading MCASTweak resources    ║
echo ║                                       ║
echo ╚═══════════════════════════════════════╝
chcp 437 >nul
curl -s -L "%fileURL%" -o "%downloadsFolder%\%fileName%"
...
rd /s /q "C:\MCASTweak Tools\OOShutup10" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\Open Shell" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\Nvidia" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\VC Redist" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\Power Plan" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\NSudo" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\Orca" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\Process Destroyer" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\Amd" >nul 2>&1
rd /s /q "C:\MCASTweak Tools\DnsJumper" >nul 2>&1
timeout 2 > nul
shutdown /r /t 0 